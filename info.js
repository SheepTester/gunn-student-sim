function init() {
  document.body.appendChild(createFragment([
    ...
    'You can also sleep; it\'s a good idea to get the recommended amount of 8 hours of sleep per night, but a single hour of sleep will do to keep you from falling asleep during a test.\n\n',
    ...
    ' (because a Spanish teacher brought it up). A warning is given when you have 3 unexcused absences, and you are suspended at 5 unexcused absences. As an academic student, you never miss academic classes, but because you think afterschool SELF is a joke, you often wonder if you should even bother going or not. Of course, as it is mandatory, you will get disciplined for cutting SELF.\n\n',
    ...
    'The teachers and conversations referenced in the game are purely fictional and are not meant to resemble nor represent anyone or anything from real life.\n\n',
